...
{
    public class LogService(ILogger<LogController> logger, UserEntity userEntity)
    {
        public LogDataWrapper ValidateLogMessage(LogData logData)
        {
            ...
            return new LogDataWrapper(LogData: logData, DateTime: DateTimeOffset.Now, null, ActionResult: string.Empty);
        }
